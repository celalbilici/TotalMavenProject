...
Özellik: Trendyol Otomasyon Muhendisi Calismasi
  ...
  Senaryo: Trendyol Sitesi Urun Gorselleri Kontrolu ve Urun Sepete Eklenmesi Tum Adimlari
    ...
    Ve indirimleri kacirma penceresini kapatirsam
    O zaman kullanici ikonunda "Hesabım" metni gorulur
    O zaman butik imajlarinin yuklendigi gorulur
    Ve tum menulere tiklanip imajlarin yuklendigi gorulur
    Ve "ELEKTRONİK" menusune tiklanirsa
    Ve "Cep Telefonu & Aksesuarlarda Fırsat" butigine tiklanirsa
    O zaman urun gorsellerinin yuklendigi gorulur
    Ve "Xiaomi Mi Band 4 Akıllı Bileklik" urunu detayina gidilir
    Ve "Sepete Ekle" butonuna basilirsa
    O zaman "Xiaomi Mi Band 4 Akıllı Bileklik" urununun sepete eklendigi gorulur
